          ...
          <div className="search-container">
            ...
            <div className="search-criteria">
              ...
              <select value={searchCriteria} onChange={handleCriteriaChange}>
                ...
                <option value="idDirection">Direction</option>
              </select>
            </div>
          </div>
              ...
              {filteredStages.map((stage) => (
                <tr key={stage.idStage}>
                  ...
                  <td className="actions-cell">
                    <button className="icon-button view-icon" onClick={() => handleDetails(stage)} data-tooltip="Consulter">
                      {iconView}
                    </button>
                    <button className="icon-button edit-icon" onClick={() => handleEdit(stage)} data-tooltip="Modifier">
                      {iconEdit}
                    </button>
                    <button className="icon-button delete-icon" onClick={() => handleDelete(stage.idStage)} data-tooltip="Supprimer">
                      {iconDelete}
                    </button>
                  </td>
                </tr>
